...
// --------------------------------------------------------------------------------------------------------------------
    ...
    function retrieveData() {
        ...
        let arr = [name1, phNum, email, job, exp];
    ...
    function readDataLocal(dataEntered) {
        ...
        let j = localStorage.setItem("Job", dataEntered[3])
        let ex = localStorage.setItem("Exp", dataEntered[4])
        ...
        let ex1 = localStorage.getItem("Exp", ex)

        let arr = [n1, p1, e1, j1, ex1];
        return arr
    ...
    function edit(td) {
        ...
        document.getElementById('job').value = row.cells[3].innerHTML;
        document.getElementById('exp').value = row.cells[4].innerHTML;
    ...
    function update() {
        ...
        row.cells[3].innerHTML = document.getElementById('job').value;
        row.cells[4].innerHTML = document.getElementById('exp').value;
        row = null;
    }
